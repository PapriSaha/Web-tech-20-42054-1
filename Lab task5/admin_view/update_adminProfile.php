<?php 
    ...
    include "../admin_controller/update_adminProfileCntrl.php" ;
                ...
                <div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>: <input type="radio" name="usertype" value="Admin" <?php if (isset($admin['usertype']) && $admin['usertype']=="Admin") echo "checked";?>> Admin
                            </td>
                        </tr>
                        <tr>
