        ...
        <input type="button" onclick="goBack()" class="link-hvr" value="← Back">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>: <span class="red font-size-20">***********</span><span ><a href="../member_view/update_memberPassword.php?user_id=<?php echo $member['user_id'] ?>" class="green"> <i class="fas fa-lock"></i> Click to Change</a></span></td>
                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><a href="../member_view/update_memberProfile.php?user_id=<?php echo $member['user_id'] ?>" class="green">Edit Profile</a></td>
                    <td></td>
                    <td><a href="../member_view/update_memberImage.php?user_id=<?php echo $member['user_id'] ?>" class="green">Update Profile Image</a></td>
                </tr>
            </table>
        </section>
    </div>
