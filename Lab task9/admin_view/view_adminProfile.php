        ...
        <input type="button" onclick="goBack()" class="link-hvr" value="← Back">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>: <span class="red font-size-20">***********</span><span ><a href="../admin_view/update_adminPassword.php?user_id=<?php echo $admin['user_id'] ?>" class="green"> <i class="fas fa-lock"></i> Click to Change</a></span></td>
                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><a href="../admin_view/update_adminProfile.php?user_id=<?php echo $admin['user_id'] ?>" class="green">Edit Profile</a></td>
                    <td></td>
                    <td><a href="../admin_view/update_adminImage.php?user_id=<?php echo $admin['user_id'] ?>" class="green">Update Profile Image</a></td>
                </tr>
            </table>
        </section>
    </div>
