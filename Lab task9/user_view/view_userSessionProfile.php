        ...
        <section>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>: <span class="red font-size-20">***********</span><span><a href="../user_view/update_userSessionPassword.php?user_id=<?php echo $user['user_id'] ?>" class="green"> <i class="fas fa-lock"></i> Click to Change</a></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><a href="../user_view/update_userSessionProfile.php?user_id=<?php echo $user['user_id'] ?>" class="green">EditProfile</a></td>
                    <td></td>
                    <td><a href="../user_view/update_userSessionImage.php?user_id=<?php echo $user['user_id'] ?>" class="green">Update Profile Image</a></td>
                </tr>
            </table>
        </section>
    </div>
